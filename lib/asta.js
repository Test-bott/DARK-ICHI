...
setMention.check = async (_0x373988, _0x3c756b = "", _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes("@" + _0x373988.user.split("@")[0]) || global.mentionasta && (_0x373988.mentionedJid.includes("@50931461936@s.whatsapp.net") || _0x373988.mentionedJid.includes("@50931461936@s.whatsapp.net") || /@2348039607375|@2349027862116/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.AstroOfficial !== "yes") {
        return;
      }
