...
`;
 ...
 smd({
   ...
   category: "downloader",
   filename: __filename,
   use: "<Hii,this is DARK-ICHI>"
 }, async (_0x55aba2, _0x56da6b) => {
   try {
     let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am ★ DARK-ICHI ★ whatsapp bot._*");
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "DARK-ICHI tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *DARK-ICHI • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 smd({
   ...
   try {
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "DARK-ICHI--" + _0x1d542b[1] + ".mp3",
       caption: Config.caption,
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("DARK-ICHI • SONG DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("DARK-ICHI• YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("ミ★ DARK-ICHI ★彡• APK DOWNLOAD LIST")) {
