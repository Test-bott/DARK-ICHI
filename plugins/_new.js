let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `★ DARK-ICHI ★ 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029Vakp0UnICVfe3I2Fe72w\n\n ${Config.botname} *©DARK-S-TEN*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*ミ★ DARK-ICHI ★彡2 CURRENTLY ACTIVE!*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document 𝙎-𝙏𝞢𝞜 | caption_");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/DRK-S-TEN/DARK-ICHI*");
     }
 ...
 let tmpUrl = "https://i.imgur.com/GTEk0gN.jpeg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
 ...
 smd({
   ...
   try {
     ...
     if (secmailData[_0x35c5db]) {
       ...
       await _0x536927.reply("*Successfully deleted the email address BY 𝙎-𝙏𝞢𝞜*");
     } else {
