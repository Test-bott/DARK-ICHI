...
async function textToLogoGenerator(message, textProUrl, text1, text2 = "ser", serviceType = "textpro", retryOnFail = true) {
  ...
  try {
    ...
    let captionContext = {} || { ...(await message.bot.contextInfo('Text to Logo', `STEN ${message.senderName}`)) };
...
smd(
  ...
  async (message, match, { cmdName }) => {
    try {
      if (!match)
        return message.reply(`*_Example : ${prefix + cmdName} STEN_*`);
...
smd(
  ...
  async (message, match, { cmdName }) => {
    try {
      if (!match)
        return message.reply(`*_Example : ${prefix + cmdName} DARK_*`);
      return await textToLogoGenerator(
        message,
...
smd({
     ...
     try {
       if (!_0x4f77c0) {
         return _0x24125a.reply("*_Example : " + (prefix + _0x2d0eda) + " DARK_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x4b2154) {
         return _0x22e0c1.reply("*_Example : " + (prefix + _0x3f34e1) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x1d8c69) {
         return _0x42806c.reply("*_Example : " + (prefix + _0x20d4b4) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x216b18) {
         return _0x25bc1d.reply("*_Example : " + (prefix + _0x67b214) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x550f0a) {
         return _0x209bcb.reply("*_Example : " + (prefix + _0x92ce9a) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!match) {
         return _0x287ddf.reply("*_Example : " + (prefix + _0x23d32d) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x217edf) {
         return _0x1658cc.reply("*_Example : " + (prefix + _0x1f1d94) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x2e2993) {
         return _0x507353.reply("*_Example : " + (prefix + _0x4b0f74) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x9fed0e) {
         return _0x106fc0.reply("*_Example : " + (prefix + _0x5b5c5c) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x54dc94) {
         return _0x2c5e4d.reply("*_Example : " + (prefix + _0x201030) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x1daf45) {
         return _0xb24628.reply("*_Example : " + (prefix + _0x317c2e) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x2712a3) {
         return _0x19ea9c.reply("*_Example : " + (prefix + _0x3da883) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x4759ef) {
         return _0x3580cc.reply("*_Example : " + (prefix + _0x25c70f) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x550c65) {
         return _0x33543a.reply("*_Example : " + (prefix + _0x5932cf) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x30ff16) {
         return _0x177d36.reply("*_Example : " + (prefix + _0x51912b) + " ICHIGO*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x2049f9) {
         return _0x1c1874.reply("*_Example : " + (prefix + _0x5462f4) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x3c787b) {
         return _0x435d39.reply("*_Example : " + (prefix + _0x4839f1) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x152a11) {
         return _0xf01fbd.reply("*_Example : " + (prefix + _0x3bd3be) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x1b1b16) {
         return _0x260877.reply("*_Example : " + (prefix + _0x3fd4bb) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x49d874) {
         return _0x4d2f55.reply("*_Example : " + (prefix + _0x4f01f0) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x474228) {
         return _0x356d68.reply("*_Example : " + (prefix + _0x31efdc) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x1526fa) {
         return _0x5840f6.reply("*_Example : " + (prefix + _0x12cadb) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0x537b5d) {
         return _0x2b9514.reply("*_Example : " + (prefix + _0x5b77bc) + " STEN_*");
       }
   ...
   smd({
     ...
     try {
       if (!_0xde1750) {
         return _0x20b5a4.reply("*_Example : " + (prefix + _0x3f5e61) + " STEN_*");
       }
