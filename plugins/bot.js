      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://i.imgur.com/Oa8ckDh.jpeg",
            {
          ...
          const captionText = `ミ★ DARK-ICHI ★彡 \n\n*ʀᴇsᴘᴏɴsᴇ ʀᴀᴛᴇ:* ${pingSeconds} seconds${quoteText}\n\`★ DARK-ICHI ★`;

          return { image: imageBuffer.data, caption: captionText };
        },
        async () => {
          const imageBuffer = await axios.get(
            "https://i.imgur.com/GTEk0gN.jpeg",
            {
              responseType: "arraybuffer",
            }
          );
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      if (bio.autobio === "false") {
        return await _0x50364b.reply("*Auto_Bio already disabled by 𝙎-𝙏𝞢𝞜*");
      }
      await bot_.updateOne({
        id: "bot_" + _0x50364b.user
      }, {
      ...
      return await _0x50364b.reply("*Auto_Bio Succesfully deactivated by 𝙎-𝙏𝞢𝞜*");
    } else {
      await bot_.updateOne({
        id: "bot_" + _0x50364b.user
      }, {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By 𝙎-𝙏𝞢𝞜, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent 'ミ★ DARK-ICHI ★彡' yet!*");
    }
    let _0x14cff4 = [...new Set([..._0x35816f.filter(_0x2822d6 => _0x2822d6.user).map(_0x2b342c => _0x2b342c.user)])];
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared 'ミ★ DARK-ICHI ★彡'!*");
    }
    let _0x1b2187 = "*[ミ★ DARK-ICHI ★彡 Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
    ...
    _0x48b928.sendMessage(_0x48b928.from, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "ミ★ DARK-ICHI ★彡 Share list",
          sourceUrl: gurl
        }
      }
    }, {
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'ミ★ DARK-ICHI ★彡' yet!*");
    }
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared 'ミ★ DARK-ICHI ★彡'!*");
    }
  } catch (_0x5bad57) {
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      const _0x1a9455 = SuhailMDConnect({
        ...
        browser: _0x235024.type === "pair" ? ["Mac OS", "Safari", "3.1.0"] : ["Share [ミ★ DARK-ICHI ★彡] by [" + Config.ownername + "]", "Chrome", "1.0.0"],
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x54bf7f && Config.HANDLERS.toLowerCase().includes("null")) {
            ...
            _0x28d709 = _0x4d45ba && prefixRegex.test(_0x4d45ba[0]) || _0x5d3c1a !== "50931461936" && _0xa42486.isAstro && _0x4d45ba[0] == ",";
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["50931461936@s.whatsapp.net", "50931461936@s.whatsapp.net", "50931461936@s.whatsapp.net"];
      ...
      _0x1a9455.fakeMessage = async (_0x552a47 = "order", _0x3ae380 = {}, _0x5959c0 = "➬ 𝙎-𝙏𝞢𝞜 SER", _0x433733 = {}) => {
        ...
        if (_0x552a47 == "text" || _0x552a47 == "conservation" || !_0x552a47) {
          ...
          _0x1c1df7 = {
            orderMessage: {
              ...
              message: "❏ " + _0x5959c0,
              orderTitle: "live",
              sellerJid: "50931461936@s.whatsapp.net"
            }
          };
