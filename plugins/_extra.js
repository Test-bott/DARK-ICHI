...
smd({
  ...
  try {
    ...
    if (!_0x11eeb1) {
      return await _0x7587f6.reply("_Need fileName, Example: document DARK-ICHI | caption_");
    }
...
smd({
  ...
  try {
    ...
    if (secmailData[_0x35c5db]) {
      ...
      await _0x536927.reply("*Successfully deleted the email address.BY DARK-S-TEN*");
    } else {
